...
class Program
{
    ...
    static void MusteriGiris()
    {
        ...
        // girilen kullanıcı adı ve şifre musteriler listesinde yoksa musteri değeri null olarak atanır.
        // listede varsa kayıtlı objeyi musteriye atar. 
        if (musteri != null)
        {
            Console.Clear();
    ...
    static void OyVer()
    {
        ...
        if (firma != null)
        {
            ...
            while (true)
            {
                ...
                {
                    // stringi double a çevirir. çevirirse true döndürür.
                    break;
                }
                else
                {
    ...
    static void KullaniciOylariListele()
    {
        ...
        // aktif müşteri ile eşleeşnler kullanicioyları listesine ekleniyor
